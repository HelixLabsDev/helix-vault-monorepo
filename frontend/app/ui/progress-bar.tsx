...
export const initialSteps: DepositStep[] = [
  ...
  },
  {
    ...
    description: "Transfer tokens to smart contract",
    status: "pending",
    estimatedTime: "~45s",
  },
  {
...
// // Usage Example - Replace this with your actual deposit button
// const DepositProgressDemo = () => {
//   const [isOpen, setIsOpen] = React.useState(false);
//   const [amount, setAmount] = React.useState("100");

//   // Replace this with your actual handleTransaction function
//   const handleDeposit = async () => {
//     // Your handleTransaction("deposit") logic goes here
//     console.log("Deposit initiated with amount:", amount);

//     // Simulate your actual transaction steps
//     await new Promise((resolve) => setTimeout(resolve, 1000));
//   };

//   return (
//     <div className="min-h-screen bg-background p-8 flex items-center justify-center space-x-4">
//       <Button onClick={() => setIsOpen(true)}>Deposit {amount} ICP</Button>
...
// export default DepositProgressDemo;
