...
echo -e "${GREEN}🔑 Switching to Helix Admin (default)...${NC}"
...
echo -e "${GREEN}👍 Approving with Helix Admin (default)...${NC}"
dfx canister call shared_ownership_backend approve_proposal "($SHARED_ID)"

echo -e "${GREEN}🔄 Switching to SNS Identity (dev)...${NC}"
dfx identity use dev
dfx canister call shared_ownership_backend approve_proposal "($SHARED_ID)"

echo -e "${GREEN}🔁 Switching back to Helix Admin (default)...${NC}"
dfx identity use default
...
echo -e "${GREEN}🗳️ Voting with Helix Admin (default)...${NC}"
